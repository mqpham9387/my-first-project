...
export class CarrierComponent implements OnInit {
  ...
  async ngOnInit() {
    this.rowData = await this.partnerService.getPartnersApi('COLOADERS');
  }
  ...
  openPopup(carrier) {
    const modalRef = this.modal.open(CarrierAddComponent, { windowClass: 'gr-modal-full', backdrop: 'static', keyboard: false })
