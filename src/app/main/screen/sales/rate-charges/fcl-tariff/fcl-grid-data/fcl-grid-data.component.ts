...
@Component({
  selector: 'app-fcl-grid-data',
  templateUrl: './fcl-grid-data.component.html',
  styleUrls: ['./fcl-grid-data.component.css'],
})

export class FclGridDataComponent implements OnInit, OnDestroy {

  @ViewChild('fclTariffGrid') fclTariffGrid: AgGridAngular;
  @Input() fclType: any;
  @Input() columnDefs: any;
  @Input() columnGPDefs: any;
